...
For more detail about how the protocol RPCs are used, see:
...
The protocol v6 definition can be found [here](https://github.com/hashicorp/terraform/blob/main/docs/plugin-protocol/tfplugin6.proto).
...
The protocol v5 definition can be found [here](https://github.com/hashicorp/terraform/blob/main/docs/plugin-protocol/tfplugin5.proto).
